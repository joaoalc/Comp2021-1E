...
public class MultDivVisitor extends PostorderJmmVisitor<List<Report>, Boolean> {
    MySymbolTable symbolTable;
    public MultDivVisitor(MySymbolTable symbolTable) {
        addVisit("Mult", this::verifyMultiplication);
        addVisit("Div", this::verifyDivision);

        this.symbolTable = symbolTable;

    }

    public boolean verifyMultiplication(JmmNode node, List<Report> reports){
    ...
    public boolean verifyDivision(JmmNode node, List<Report> reports){
